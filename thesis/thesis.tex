...
\begin{document}
  ...
  \chapter{Element queries}\label{chp:eq}
    ...
    \section{Possible solutions}\label{sec:solutions}
      ...
      Since a \gls{JavaScript} library do not depend on vendors of \glspl{layout engine} (other than features in the current language specifications) it can therefore be designed in any desired way.
  ...
  \chapter{Implementation}
    ...
    \section{Element resize detection}\label{sec:imp_erd}
      \begin{metatext}
        ...
        The \gls{element} resize detection system will therefore be the backbone of the library.
      ...
      \end{metatext}
        ...
        Since the library needs to support all commonly used \gls{HTML} \glspl{element} a solution to observe resize events of any \gls{element} needs to be found.
