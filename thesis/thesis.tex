  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Layout engines}
      ...
      \subsection{Parallelization}\label{sec:parallel}
        ...
        Siblings of the layout tree can be processed independently of each other (in the general case), and is suitable to parallelize with a work-stealing algorithm\footnote{See \url{http://supertech.csail.mit.edu/papers/steal.pdf} for more information about work-stealing algorithms.}.
