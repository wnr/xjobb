    ...
    \chapter{Browsers} 
      ...
      \section{The origin of the web}
        \begin{metatext}
          ...
          This section is a summary of \normalfont{\cite{overview_of_tcp_ip}\cite{internetsociety_history_internet}}.
        \end{metatext}

        In the early 1960's \emph{packet switching} was being researched, which is a fundamental networking technology behing the Internet.
        ...
        \textsc{arpanet} was funded by the United States Department of Defense in order (DoD) to interconnect their research sites in the United States.
        The first nodes of \textsc{arpanet} was installed at four major universities in the western United States in 1969.
        In 1971 the network spanned the whole country and had in 1973 connections to Europe.
