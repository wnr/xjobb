...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \todo[inline]{Write about the targeted browser compatability.}
...
#foo:eq(min-width: 500px) #child { 
  ...
  font-size: 1em;
      ...
      \section{Native API design}
        ...
        Since it would be favorable to be able to specify multiple conditional rule sets for the element queries (like media queries) the \textsc{css} syntax may be of the form as presnted in listing~\ref{code:mq-eq-syntax}.
  ...
  \part{Third-party framework}
    \chapter{Analysis of approaches}
      \section{Current implementations}
        ...
        \todo[inline]{Write somehwere that an extra layout on element resize is inevitable since it is required in theory.}
    \chapter{Framework design}
      \begin{metatext}
        ...
        The subsystems of the framework and their interactions will also presented.
      \end{metatext}
      ...
      \section{Technical goals}
        ...
        \begin{enumerate}
          \item The framework needs to be performant enough for heavy applications running on light devices.
