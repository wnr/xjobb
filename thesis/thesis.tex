...
\begin{document}
  ...
  \chapter{Background}\label{ch:background}
    \begin{metatext}
      ...
      Section \ref{sec:web-dev} will present a brief history of web development and motivate why responsive web design and modular development are desired techniques in modern web development.
