...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Outline}
      ...
      Identified technical requirements will be given in order to motivate the framework architecture and \textsc{api} design.
    ...
    \chapter{Framework design}
      ...
      \section{API design}\label{sec:elq-api}
        \begin{metatext}
          ...
          First, the public \textsc{api} of the core will be presented, followed by the plugin \textsc{api}.
          After that, all plugins will be described in depth addressing their features, dependencies and \textsc{api}'s.
        \end{metatext}

        Recall from section~\ref{sec:arcithecture} that the bigger part of the public \textsc{api} is provided by plugins.
        ...
        \subsection{Public API}
          ...
          Instead, a constructor function that creates \textsc{elq} instances is provided in order to be able to inject dependencies.
          ...
          The constructor returns an object containing the core public \textsc{api} methods of the \textsc{elq} instance.
          \begin{lstlisting}[caption={Example usages of the \textsc{elq} custrctor function.},captionpos=b,label={code:elq-ctor}]]
