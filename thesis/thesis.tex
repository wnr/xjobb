...
\begin{document}
  ...
  \chapter{Discussion}\label{ch:discussion}
    ...
    At least, the solution performs significantly better than the existing solutions as used by related libraries.
    ...
    So, a flash of invalid style at page load is inevitable (and is also the case with all related libraries that evaluate element queries at runtime).
  ...
  \chapter{Future work}\label{ch:future-work}
    ...
    However, since they process their \glslink{batch processing}{batches} independent of each other, the element resizing detection subsystem forces a layout before the plugin \glslink{batch processing}{batch} processor is invoked.
