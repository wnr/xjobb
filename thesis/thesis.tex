...
\begin{document}
  ...
  \chapter{Background}\label{ch:background}
    This chapter aims to present sufficient background to understand and why element queries is a desired feature why it is hard to implement natively in browsers.
    Chapter \ref{sec:web-dev} will present a brief history of web development and motivate why responsive web design and modular development are desired techniques in modern web development.
    Chapter \ref{sec:layout-engines} describes briefly how layout engines operates, with focus on the layout process, to later present how they can be parallelized in section \ref{sec:parallel}.
