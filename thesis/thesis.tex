...
\begin{document}
  ...
  \begin{foreignabstract}{swedish}
    ...
    För att möjliggöra skapandet av enkapsulerade responsiva moduler, i väntan på webbläsarstöd, har ett tredjepartsbibliotek för \emph{element queries} skapats i \emph{JavaScript}.
  ...
  \chapter{Empirical Evaluation}\label{ch:eval}
    ...
    \section{Performance}\label{sec:eval-performance}
      The following tests were performed on a computer with a 2.7 GHz processor and 16GB of memory\footnote{The serial number of the computer is C02N4G9TG3QD and the vendor is Apple Inc. CPU: 2.5 GHz Intel Core i7. Memory: 16 GB 1600 MHz DDR3. GPU: Intel Iris Pro 1536 MB.}.
      ...
      \subsection{elq-breakpoints plugin}
        \todo[inline]{Write this one.}
