...
... {
  ...
  \part{Third-party framework}
    ...
    \chapter{Framework design}
      ...
      The technical goals of \textsc{elq} will be stated in section~\ref{sec:techincal-goals}.
      In section~\ref{sec:arcithecture} the architecture will be described, and the subsystems of \textsc{elq} will be presented.
      Last, the \textsc{api} will be defined in section~\ref{sec:elq-api}.
      ...
      \section{Technical goals}\label{sec:techincal-goals}
        ...
        \begin{enumerate}
          ...
          \item \textbf{Ease of use}
            \begin{enumerate}
              ...
              \item The \textsc{api}'s need to feel natural and should not seem alien to web developers.
        ...
        In the same way, too many advanced features may decrease the ease of use and simplicity of the \textsc{api}'s.
        ...
        By separating it from the core framework (and the other plugins), only developers that really desire the prolyfill behavior must handle the rapid \textsc{api} changes.
      ...
      \section{Architecture}\label{sec:arcithecture}
        \begin{metatext}
          ...
          The major subsystems of the core framework will also be explained in depth. \todo{Should they be explained in depth here or in the implementation section? Maybe rewrite this sentence.}
        \end{metatext}
        ...
        \begin{figure}
          ...
          \medskip
          \caption{
            The overall framework architecture, which shows how the framework is divided into two parts; the core and plugins. 
