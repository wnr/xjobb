  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Layout engines}\label{sec:layout-engines}
      ...
      \subsection{Render trees}\label{sec:render-tree}
        ...
        In contrast to the \gls{DOM} tree, the \gls{render tree} only contains \glspl{element} that affects the rendered result in any way.
        ...
        This is because some properties depend on the flow of the \gls{document}, which cannot be be resolved by style cascading and this need to be computed through a layout.
