...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \todo[inline]{This or the thesis? Now both is being used.}
    \todo[inline]{runtime or run time? same for parse time. Both is being used right now.}
    \todo[inline]{Container or parent element? Using both now.}
    \todo[inline]{Renamed framework to library?}
    \todo[inline]{Write about the targeted browser compatibility.}
    \todo[inline]{Word says that all "their own" is wrong.}
    \todo[inline]{The word "layouting" seems wrong.}
  ...
  \part{Theory}
    \chapter{Layout engines}
      \begin{metatext}
        ...
        This chapter will give a brief explanation of the layouting flow that the engines generally perform, and how content changes affect the engine\todo{Write about content changes or remove this.}.
