...
\begin{document}
  ...
  \begin{foreignabstract}{swedish}
    ...
    Tyvärr kräver responsiva moduler att användaren av en modul defininerar de olika responsiva stilarna eftersom endast användaren vet i vilket kontext modulen används.
  ...
  \chapter{Introduction}
    ...
    \section{Objective}
      ...
      Research has been done about the problems of implementing element queries \glslink{native}{natively}, in order to get a deeper understanding of the potential shape of a standardized \gls{API}.
    ...
    \section{Choice of methodology}
      ...
      Knowledge about the problem has been gathered by a literature study (that is mostly based on material published by the W3C), and possible approaches to non-native solutions have been evaluated by analyzing related work.
