...
\begin{document}
  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Web development}
      ...
      \todo[inline,color=red]{Tomas: Write what will be presented here, who should read it and why.}
      ...
      \subsection{From documents to applications}
        \begin{metatext}
          This section will describe the transition from \glspl{browser} rendering simple \glspl{document} to being hosts for complex applications.
    ...
    \section{Layout engines}
      \begin{metatext}
        ...
        This section will give a brief explanation of the layout flow that the engines generally perform.
      ...
      \subsection{Parallelization}\label{sec:parallel}
        ...
        \todo[inline,color=green]{Marcos: Reference to work-stealing system?}
        \todo[inline]{Reference http://supertech.csail.mit.edu/papers/steal.pdf?}
      ...
      \subsection{Layout thrashing and how to avoid it}
        \begin{metatext}
    ...
    \section{API design}\label{sec:elq-api}
      ...
      \subsection{Plugins}
        ...
        \subsubsection{Breakpoints}
          ...
          \todo[inline]{Change above/below to >=/<=}
        \subsubsection{Mirror}
          ...
          Paragraphs may appear nested in other elements, that may be generated dynamically at run time.
          ...
          \begin{lstlisting}[gobble=12,caption={},captionpos=b,label={code:elq-mirror-example}]]
          ...
          \begin{lstlisting}[gobble=12,caption={},captionpos=b,label={code:elq-mirror-example-cont}]]
          ...
          \begin{lstlisting}[gobble=12,caption={},captionpos=b,label={code:elq-mirror-example-cont-2}]]
            /* HTML */
            <div class="container" elq elq-breakpoints elq-breakpoints-width="300 500">
              <div>
          ...
          \end{lstlisting}
          Notice that the breakpoint classes now are used in conjunction with the paragraph element instead of the container element.
  ...
  \chapter{State of the Art}\label{ch:state-of-the-art}
    ...
    \todo[inline,color=red]{Tomas: Move this to later part of thesis to start talking about my own work directly?}
