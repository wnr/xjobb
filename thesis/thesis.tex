...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Delimitations}
      ...
      \item Theory about layout engines, programming languages of the web, \gls{responsive} \gls{web} design and modularity will be given to fully understand the problem.
      \end{itemize}
  ...
  \part{Background}\label{part:background}
    ...
    \chapter{Browsers} 
      ...
      Since not only \gls{hypertext} is interlinked on the \gls{web}, the term \emph{\glslink{hypertext}{hypermedia}} can be used as an extension to \gls{hypertext} that also includes other nonlinear medium of information (images, videos, etc.).
