    ...
    \chapter{Element queries}
      ...
      \section{Problems}
        ...
        \subsection{Performance}
          ...
          Since a layout of the element query selector target is required in order to resolve the correct element style, such internal \textsc{api}'s requires a layout in order to obtain the correct element style (even for non-layout related properties).
...
... {
  ...
  \part{Third-party framework}
    ...
    \chapter{Framework design}
      ...
      This name serves as a prefix for many of the framework \textsc{api}'s, and will be frequently used in the report from now on.
