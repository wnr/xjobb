...
\newglossaryentry{third-party}{
  name={third-party},
  description={Refers to \glspl{API} and systems implemented on top of the browser, usually in \gls{JavaScript}. Such APIs and systems must be included by developers into the document, and are usually not described by standards specifications}
}
\newglossaryentry{hypertext}{
  name={hypertext},
  description={Documents with of text and media with links (hyperlinks) to other documents immediately accessible for the user. Often used as a synonym for hypermedia}
}
\newglossaryentry{JavaScript}{
  name={JavaScript},
  description={\Gls{native} browser script language. Web documents often include JavaScript to make the documents more dynamic and interactable}
}
  ...
  \part{Background}\label{part:background}
    ...
    \chapter{Browsers} 
      \begin{metatext}
        ...
        This chapter will give a brief history of browsers and how the \gls{web} transitioned from handling science documents to commercial applications.
      ...
      As already stated, the \gls{WWW} is a system that operates through the Internet.
      The \gls{WWW} is usually shortened to simply \emph{the \gls{web}}.
      The \gls{web} is a system for accessing interlinked \gls{hypertext} documents and other media such as images and videos.
      Since not only \gls{hypertext} is interlinked on the \gls{web}, the term \emph{\glslink{hypertext}{hypermedia}} can be used as an extension to \gls{hypertext} that also includes other nonlinear medium of information (images, videos, etc.). \todo{Are images and videos really nonlinear?}
      ...
      Hypertext documents are written in \gls{HTML}, and often includes \gls{CSS} for styling and \gls{JavaScript} for custom user interactions.
      ...
      \section{The origin of the web}
        ...
        \subsection{The World Wide Web}\label{sec:www}
          \begin{metatext}
            Now that the history of the Internet has been described, it is time to talk about the birth of the \gls{WWW}.
          ...
          The concept of browsers is described, with a client-server model the browser would fetch the \gls{hypertext} documents, parse them and handle the fetching of all media linked in the \gls{hypertext}.
          ...
          As a side note, the Gopher protocol was developed in parallel to the \gls{WWW} by the University of Minnesota.
          ...
          The listed documents of a server could then be presented as \gls{hypertext} menus to the client (much like a \gls{web} browser).
          ...
          A big difference between the \gls{web} and the Gopher platform is that the Gopher platform provided \gls{hypertext} menus presented as a file system while the \gls{web} \gls{hypertext} links inside \gls{hypertext} documents, which provided greater flexibility.
      ...
      \section{The history of browsers}
        ...
        \begin{metatext}
          ...
          To fulfill the vision that users would be able to skip to the linked documents ``with a click of the mouse'' the users needed a client to handle the fetching and displaying of the \gls{hypertext} documents, hence the need for browsers were apparent.
    ...
    \chapter{Web development}
      ...
      \section{From documents to applications}
        ...
        As described in section~\ref{sec:www}, browsers initially were applications that displayed \gls{hypertext} documents with the ability to fetch linked documents in an user friendly way.
        Static content were written in \gls{HTML}, which could include hyperlinks to other \gls{hypertext} documents or hypermedia.
        ...
        As client side scripting matured and standardized into \emph{\gls{JavaScript}}, plugins slowly decreased in popularity.
        ...
        As \gls{JavaScript} and \gls{HTML} supported more features, websites turned into small applications with user sessions (using cookies) and user interfaces.
        Still, parts of the applications were defined as \gls{HTML} pages, fetched from the server when navigating the site.
        When the \emph{XMLHttpRequest} \gls{API} was supported in the major browsers, pages no longer needed to reload in order to fetch new content as XMLHttpRequest enabled developers to perform asynchronous requests to servers in \gls{JavaScript}.
...
@media screen and (min-width: 601px) {
  ...
  \part{Theory}\label{part:theory}
    \chapter{Layout engines}
      ...
      \end{figure}
      It is shown that the layout engine is located between the \emph{browser engine} system and the network, \gls{JavaScript}, \gls{XML} parsing and display backend.
      ...
      The main responsibility of the layout engine is to render the current state of the fetched \gls{hypertext} document.
      ...
      \section{Constructing DOM trees}\label{sec:dom-tree}
        ...
        The \gls{DOM} provides an interface for programs (\gls{JavaScript} scripts in the browser) to dynamically access and mutate the content, structure and style of documents.
        ...
        Layout engines construct \gls{DOM} trees by parsing \gls{HTML} with any included \gls{CSS} and \gls{JavaScript}.
