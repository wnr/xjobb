  ...
  \chapter{Library design}
    ...
    \section{API design}\label{sec:elq-api}
      ...
      \subsection{Plugin API}
        ...
        \todo[inline]{Write about getPlugin}
  ...
  \chapter{Implementation}
    ...
    \section{Element resize detection}\label{sec:imp_erd}
      \begin{metatext}
        ...
        As the element resize detection system is a core subsystem of \abbr{elq}, and extensively used by the \code{elq-breakpoints} plugin, it is important to find a both resiliant and performant approach to detect element size changes.
      ...
      \end{metatext}
        ...
        \todo{The approach cannot listen to all elements. Void elements (I think it is called that) for instance cannot have elements injected. However, many more elements than only the frames elements can be used.}
