  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Layout engines}\label{sec:layout-engines}
      \begin{metatext}
        ...
        This section will give a brief explanation of the layout process that the engines generally perform.
        It will also cover some optimizations that are done and which parts of the layout process that can be done in parallel.
        Lastly, layout thrashing will be presented and how it can be avoided.
