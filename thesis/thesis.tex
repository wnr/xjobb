...
... {
  ...
  \part{Third-party framework}
    ...
    \chapter{Framework design}
      ...
      \section{Technical goals}
        ...
        \begin{enumerate}
          ...
          \item Existing modules written with media queries should be automatically converted to element queries so that existing third-party modules can be used in element query power applications.
    ...
    \chapter{Implementation}
      \section{Element resize detection}
        \begin{metatext}
      ...
      \section{Avoiding layout thrashing}
