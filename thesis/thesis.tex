...
\begin{document}
  ...
  \chapter{Background}\label{chp:background}
    ...
    \section{Web development}\label{sec:web-dev}
      ...
      \todo[inline]{Describe general use case here or in 3.1?}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%% Layout engines
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \section{API design}\label{sec:elq-api}
      ...
      \subsection{Plugins}
        ...
        \subsubsection{Breakpoints}\label{sec:plugin-breakpoints}
          ...
          \todo[inline]{Write about noclasses option.}
  ...
  \chapter{Empirical Evaluation}
    ...
    \section{ELQ Bootstrap}\label{sec:eval-bootstrap}
      ...
      Since the Bootstrap \gls{CSS} is generated by the preprocessor \gls{LESS}, they are defined as constants as presented in listing~\ref{code:bootstrap-less-breakpoints}.
      ...
      The rewriting of the \gls{LESS} code, the addition of the \gls{ELQ} library and the initating JavaScript is all that is required to make the double column documentation page behave as expected.
