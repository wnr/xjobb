...
<html>
  <body>
    ...
    \chapter{Element queries}
      \begin{metatext}
        Now that a good understanding of \glspl{browser} (especially the \gls{layout engine}), \gls{responsive} design, and modular development has been acquired it is time to address element queries --- the key concept to modular \gls{responsive} \gls{web} design.
