  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Web development}\label{sec:web-dev}
      ...
      \subsection{From documents to applications}\label{sec:doc-to-app}
        ...
        As further described in Section~\ref{sec:www} of the appendix, \glspl{browser} were initially applications that displayed \gls{hypertext} \glspl{document} with the ability to fetch linked \glspl{document} in a user friendly way.
