...
var elements = [...];
doubleWidths(elements); // ~600 ms
        \end{lstlisting}

        \begin{lstlisting}[caption={Example of avoiding layout thrashing by batch processing reads and writes to the \gls{DOM}. The code reads and double the widths of 1000 elements in \textasciitilde6 ms.}, captionpos=b, label={code:thrashing-example-fixed}]
/* JS */
