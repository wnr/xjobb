...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Significance}
      ...
      Clearly, no sound option exists for having \gls{responsive} modules and solving this problem would be a big advancement to \gls{web} development.
      ...
      No related library is currently capable of such positive results.
    ...
    \section{Choice of methodology}
      ...
      Only the constructed library was evaluated, since it can be concluded by analyzing related libraries that none would be able to achieve equivalent results.
  ...
  \chapter{Conclusions}\label{ch:conclusions}
    ...
    Such positive properties are not provided by any other related library.
