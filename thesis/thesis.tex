...
\begin{document}
  ...
  \chapter{Element queries}\label{ch:eq}
    ...
    \section{Definitions and Usages}\label{sec:eq-definitions}
      ...
      \noindent
      Element queries is the solution to the problem of \gls{responsive} modules as described in Section~\ref{sec:rwd-modular-problem}, since they allow modules to conditionally style themselves by element criterion.
