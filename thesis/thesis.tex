...
#outer:eq(width > 500px) #foo { ... }
        ...
        Another approach to enable element queries for developer is to provide a \gls{third-party} \gls{JavaScript} framework.
        Since a \gls{JavaScript} framework do no depend on \glspl{layout engine} vendors (other than features in the current langauge specifications) it can therefore designed in any desired way.
