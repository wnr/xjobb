...
\begin{document}
  ...
  \chapter{Discussion and Conclusions}\label{ch:discussion-conclusions}
    ...
    \section{Future work}
      ...
      This could be solved by sharing a \glslink{batch processing}{batch} processor between them so that both read, write, and force operations are executed synchronized with each other.
