    ...
    \section{Details of subsystems}\label{sec:library-imp-details}
      ...
      \subsection{Element resize detection}\label{sec:imp_erd}
        ...
        \begin{enumerate}
          ...
          \item\label{itm:erd-algo-original-scroll-7} When both handlers have been called, the injection is finished and observers can be notified on resize events of $e$ when \code{scroll} events occur.
        \end{enumerate}
