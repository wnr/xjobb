...
\begin{document}
  ...
  \chapter{Empirical Evaluation}
    ...
    Section~\ref{sec:eval-bootstrap} evaluates the \glspl{API} by a case study that rewrites the popular Bootstrap framework to use element queries.
    Bootstrap uses media queries heavily to provide responsive components and \gls{CSS} classes that is often desired to use in web applications.
    ...
    \section{Performance}\label{sec:eval-performance}
      The following tests were performed on a computer with a 2.7 GHz processor and 16GB of primary memory\footnote{The serial number of the computer is C02N4G9TG3QD and the vendor is Apple Inc. CPU: 2.5 GHz Intel Core i7. Memory: 16 GB 1600 MHz DDR3. GPU: Intel Iris Pro 1536 MB. Storage Disk: 500 GB SSD.}.
