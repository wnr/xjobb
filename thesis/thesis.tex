...
\begin{document}
  ...
  \chapter{The element queries library}\label{chp:library}
    ...
    The technical goals of \gls{ELQ} will be stated in Section~\ref{sec:techincal-goals}.
    In Section~\ref{sec:arcithecture} the architecture will be described, and the subsystems of \gls{ELQ} will be presented.
