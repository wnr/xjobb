...
\begin{document}
  ...
  \chapter{Introduction}
    \todo[inline]{Philipp: Grammar: avoid future tense if possible. (Avoiding "will")}
  ...
  \part{Background}
    ...
    \chapter{Web development}
      ...
      \section{From documents to applications}
        ...
        Since \textsc{html} is only a markup language it is not possible to generate dynamic content, which was sufficient at the time \textsc{html} was only used for annotating links in research documents.
