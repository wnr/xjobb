  ...
  \part{Theory}
    \chapter{Layout engines}
      ...
      \section{Constructing \textsc{DOM} trees}\label{sec:dom-tree}
        \begin{metatext}
          Here a brief explenation of \textsc{dom} trees will be given, and how they are constructed.
      ...
      \section{Render trees}\label{sec:render-tree}
        \begin{metatext}
          When the \textsc{DOM} tree has been constructed, it is time for the layout engine to create the render tree.
          Here an explenation of the creation process and the structure of render trees will be given.
