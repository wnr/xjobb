...
\begin{document}
  ...
  \begin{abstract}
    ...
    In order to create encapsulated responsive modules, elements must be able to be conditionally styled by \emph{element} property criteria, which is known as \emph{element queries}.
