...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Problem statement}
      ...
      \todo[color=green]{Marcos: Cannot write this. Must reformulate. Waiting for Marcos's respose to my questions.}
    ...
    \section{Objective}
      ...
      \begin{itemize}
        ...
        \todo[inline]{Waiting for Marcos to reply to my questions.}
        ...
        \todo[inline]{I've been using listen since JS is talking about event "listeners". I'm awaiting Marcos response regarding this.}
  ...
  body {
    background-color: yellow;
      ...
      \section{Modularity}\label{sec:modularity}
        ...
        \todo[inline,color=green]{Marcos: This section is not balanced, you should also describe criticisms of modular design. I.e., they eventually lead to complexity or modules that don't integrate. }
        \todo[inline]{Waiting for Marcos response}
