...
@media screen and (min-width: 601px) {
  ...
  \part{Theory}
    ...
    \chapter{Element queries}
      ...
      \section{Problems}
        \begin{metatext}
          The main reason why element queries hasn't been implemented natively in browsers is because they bring problems and limitations to the browsers.
          It is key to understand the problems in order to speculate about a potential native \textsc{api} design.
