    ...
    \chapter{Implementation}
      \section{Element resize detection}\label{sec:imp_erd}
        ...
        \end{metatext}
          ...
          Since the polling will be performed all the time, the overall page performance will be decreased even if the page is idle, which is undesirable especially for battery devices.
          ...
          \end{itemize}
          It has been shown by \cite{backalley} that \code{object} are the most suitable frame element to use for this purpose, as they have good browser compatibility, adequate performance and are easy to work with.
