...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Choice of methodology}
      ...
      To write the non-\gls{native} library in \gls{JavaScript} was chosen because it is the common denominator scripting language of browsers.
      For increased compatibility and ease of use it was chosen to not write the library in any language that compiles to \gls{JavaScript}.
