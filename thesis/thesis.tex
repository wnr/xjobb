...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \todo[inline,color=green]{Marcos: I don't think you ever defined what a "native solution" actually is.}
    \todo[inline,color=green]{Marcos: you might want to add some kind of marker for words that are defined (e.g., an underline).}
    \todo[inline,color=green]{Marcos: listener -> observer}
    \section{Targeted audience}
      ...
      \todo[inline,color=green]{Just maybe add a note at the start that states that there is a bit of technical jargon and hence there is a glossary at the end of the document (and maybe underline the words, if Latex will do it). I didn't find out until later that there was a glossary. That helps the reader better understand/look up ambiguous/contentious terms to see how you are using them.}
    ...
    \section{Objective}
      ...
      \begin{itemize}
        ...
        \todo[inline,color=green]{Marcos: How can one listen to element size changes without any native support?}
        \todo[inline]{JS is using both "listen" and "observe". Marcos thinks observe sounds more natural. Should probably stick to that then.}
