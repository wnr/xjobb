...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Problem statement}
      ...
      Participants of the W3C, which include both paying members and the public, are interested in solving the problem and possible solutions are being discussed.
      ...
      \begin{itemize}
        ...
        Far worse, since selectors would depend on layout style, style and layout computations become hard to parallelise.
      \end{itemize}
    \section{Objective}
  ...
  font-size: 1em;
      ...
      \section{Native API design}\label{sec:native-eq}
        \begin{metatext}
          ...
          This is based on the current information and approaches of \gls{W3C} and \gls{RICG}, and should therefore be regarded as a guideline of the shape of a potential standardized \gls{API}.
