  ...
  \part{Third-party framework}\label{part:framework}
    ...
    \chapter{Analysis of approaches}\label{ch:current_approaches}
      ...
      \begin{itemize}
        ...
        \item \textbf{Static}: Approaches that in a compilation step calculates desired element queries and transforms them into media query powered layouts.
      ...
      \begin{table}[ht]\center
        ...
        \begin{tabular}[t]{ l l l l p{5cm} }
          ...
          \cite{eq_imp_localised-css} & Invalid syntax & Automatic & Dynamic & Runtime parsing of CSS. Unfinished. Polling. \\
          \cite{eq_imp_classquery} & Valid syntax & - & Static & Writes media queries to style on load\\
          \cite{eq_imp_breakpointsjs} & Valid syntax & Semi-Automatic & Dynamic & JS-centric approach \\
          \cite{eq_imp_mediaclass} & Valid syntax & Semi-automatic & Dynamic & Custom inline JS syntax \\
          ...
          \cite{eq_imp_sickles} & Valid syntax & Semi-automatic & Dynamic & Part of bootstrap-like framework. No JS API, instead parses CSS. \\
