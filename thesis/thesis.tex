...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Choice of methodology}
      ...
      The premises of the \gls{Bootstrap} altering method are considered valid since \gls{Bootstrap} is widely used in production, has a large code base, and has sufficiently advanced responsive features that is needed for such evaluation to be sound.
