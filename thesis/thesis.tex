  ...
  \chapter{Introduction}
    ...
    \section{Objective}
      ...
      \begin{itemize}
        ...
        \item If a custom \abbr{api} is developed, how would one make third-party modules (that uses media queries) work without demanding a rewrite of all third-party modules? \todo{Remove me?}
    ...
    \section{Significance}
      ...
      \abbr{w3c} receives requests and questions about it, but the answer seems to be that no solution will be provided in the near moment. \todo{"near moment". Have I written this somewhere else?}
    ...
    \section{Delimitations}
      ...
      \item Theory about layout engines, \abbr{css}, \abbr{html}, and responsive web design will be given to fully understand the problem. \todo{Modular theory?}
      \end{itemize}
      ...
      \item No complete history of browsers, the Internet or responsive web design will be given other than necessary.\todo{Rewrite a bit. Seems like a very clumsy sentence.}
      \end{itemize}
    \section{Outline}
      The thesis is divided into four parts. The first part \emph{\ref{part:background}~\nameref{part:background}} presents some history of the web platform and describes concepts needed to understand the problem.
      ...
      Possible solutions to the given problems will also be presented followed by a theoretization about how an \abbr{api} could be designed. \todo{Clumsy sentence. change theoretization to something else? Probably?}
  ...
  \part{Background}\label{part:background}
    ...
    \chapter{Browsers} 
      \begin{metatext}
        ...
        This chapter will give a brief history of browsers and the rise of the web. \todo{rise of the web, is that valid grammar?}
        This section is a summary of \normalfont{\cite{internet_live_stats,internet_of_things,wiki_hypermedia,w3c_www,oed}}.
      \end{metatext}

      Before addressing the birth of the web, let's \todo{Using let's here. Should not.} define the meaning of the concepts of the \emph{Internet}, \emph{Web} and \emph{World Wide Web}.
      ...
      Or is it the \abbr{icann}\footnote{The Internet Corporation for Assigned Names and Numbers} organization that has the responsibility for managing the \abbr{ip} addresses in the Internet namespace? \todo{Clumsy sentence.}
      ...
      As already stated, the Word Wide Web (abbreviated \abbr{www} or \abbr{w3}) is a system that operates through the Internet. \todo{on top of?}
      ...
      Since not only hypertext is interlinked on the web, the term \emph{hypermedia} can be used as an extension to hypertext that also includes other nonlinear medium of information (images, videos, etc.). \todo{Are images and videos really nonlinear?}
      ...
      \section{The origin of the web}
        ...
        The first nodes of \abbr{arpanet} was installed at four major universities in the western United States in 1969 and two years later the network spanned the whole country. \todo{Write US instead of United States?}
    ...
    \chapter{Layout engines}
      ...
      \begin{figure}
        ...
        \tiny
          ...
          \node[mynode, below=of layout-engine, right=0.1cm of dummy] (xml) {\abbr{xml}};
...
#foo:eq(min-width: 500px) #child { 
  ...
  font-size: 1em;
      ...
      \section{Native \abbr{api} design}
        \begin{metatext}
...
... {
  ...
  \part{Third-party framework}\label{part:framework}
    ...
    \chapter{Framework design}
      ...
      \section{\abbr{api} design}\label{sec:elq-api}
        \begin{metatext}
