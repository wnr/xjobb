            ...
            \begin{minipage}{.5\textwidth}
              ...
              \begin{tikzpicture}
                \begin{axis}[
                  ...
                  \addplot+[orange, mark options={orange}] table[x=n elements,y=memory,col sep=comma] {./data/erd-scroll-original.csv};
                  \addplot+[red, mark options={red}] table[x=n elements,y=memory,col sep=comma] {./data/erd-object-original.csv};
                  \addlegendentry{Original object-based solution}         
                  \addlegendentry{Scroll-based solution}
                \end{axis}
              \end{tikzpicture}
