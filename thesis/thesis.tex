  ...
  \chapter{Implementation}
    ...
    \section{Element resize detection}\label{sec:imp_erd}
      ...
      \end{metatext}
        ...
        See figure~\ref{fig:erd-original-object} for a graph that shows the performance of the object-based element resize detector provided by \cite{backalley}.
        ...
        \begin{figure}[h!]
          ...
          \begin{center}
              ...
              \centering
                \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      xlabel=X Axis \emph{number of elements}, % Set the labels
                      ylabel=Y Axis \emph{install time},
                    ...
                    % the .csv file (on top)
                    table[x=n elements,y=install time,col sep=comma] {./data/erd-object-original.csv};
            ...
            \begin{minipage}{.5\textwidth}
              ...
              \end{tikzpicture}
            \end{minipage}
          \caption{The install performance of the original object-based element resize detection solution provided by \cite{backalley}. The left graph shows the installation time. The right graph shows the heap memory used when all \code{object} elements have been installed.}
