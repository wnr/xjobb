...
\begin{document}
  ...
  \chapter{Empirical Evaluation}
    ...
    \section{Bootstrap}\label{sec:eval-bootstrap}
      ...
      As shown in listing~\ref{code:bootstrap-less-breakpoints}, media queries are easily replaced by element queries.
      \begin{lstlisting}[gobble=8,label={code:bootstrap-less-breakpoints},caption={},captionpos=b]]
        /* LESS */
      ...
      Most changes were of the character shown in listing~\ref{code:bootstrap-less-breakpoints}, which basically replaces the media query syntax with the \gls{ELQ} element queries syntax.
