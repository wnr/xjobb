      ...
      \end{metatext}
        ...
        \begin{enumerate}
          \item\label{itm:erd-approach-polling} \textbf{Polling}:
            ...
            This can be achieved by using the \gls{JavaScript} \code{setInterval}\footnote{See \url{http://www.w3.org/TR/2011/WD-html5-20110525/timers.html} for more information about \gls{JavaScript} timer functions.} function.
