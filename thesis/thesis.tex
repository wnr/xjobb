    ...
    \chapter{Framework design}
      ...
      \section{Architecture}
        \begin{metatext}
          ...
          The major subsystems of the core framework will be explained in depth.
        \end{metatext}
        ...
        \begin{figure}
          ...
          \tiny
            ...
            \node[title, left=12em of middledummy] (coretitle) { \normalsize Core };
            ...
            \node[title, right=12em of middledummy] (pluginstitle) { \normalsize Plugins };
            ...
            \node[mylabel, rotate=-90, text width=10em] (interpluginapilabel) at ($ (mirror.east) + (1.5,0) $) {Interplugin API};
            ...
            \draw[o] let \p1=(pubapibottom), \p2=(plugins.south) in ($ (plugins.south) + (-0.5,0) $) -| ($ (\x2,\y1) + (-0.5,0) $);
            \node[mylabel, right=4em of pubapibottom, text width=5em] (pubapilabel) {Public API};
        ...
        The core consists of fundamental and general subsystems that are utilized by the plugins.
        The plugins form the bigger part of the \textsc{api} in the sense that they decide how which features exists and how they work.
        Developers will never be programming against the core directly, and are therefore kept hidden from the public \textsc{api}.
