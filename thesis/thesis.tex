  ...
  \part{Theory}
    \chapter{Layout engines}
      ...
      \section{The layout process}
        ...
        In section~\ref{sec:style-computation} it was stated that some style properties needs a layout in order to be resolved with a final value.
        Because the \textsc{api} of \code{getComputedStyle} promises resolved values for all style properties, a call will force a layout (flushing the changes buffer).
