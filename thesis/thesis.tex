...
\begin{document}
  ...
  \chapter{ELQ --- The element queries library}\label{chp:library}
    ...
    This section is the key motivation to why the library should be plugin based.
    ...
    It is in this section where it is shown exactly how users can alter subsystems of the core.
    In addition, it is shown how limitiations of \gls{CSS} are overcome by creating a plugin.
    ...
    \todo[inline]{Write a little intro to this meta like "Now that sufficient knowledge about eq and blabla ....?"}
  ...
  \chapter{Empirical Evaluation}
    ...
    \section{Performance}
      ...
      \subsection{Element resize detection}\label{sec:eval-perf-erd}
        ...
        Due to problems such as layout thrashing, bugs and an undesired \gls{API}; the scroll-based solution provided by \cite{eq_imp_css-element-queries} was completely rewritten to better fit \gls{ELQ}.
