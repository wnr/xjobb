...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Delimitation}
      ...
      The problems of implementing element queries \glslink{native}{natively} is addressed, but no efforts has been made to solve the problems.
      ...
      % \begin{itemize}
      % \item A \gls{third-party} non-\gls{native} implementation of element queries has been developed.
      % \item 
      % \item 
      % \end{itemize}
