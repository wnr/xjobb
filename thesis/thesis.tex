  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Layout engines}\label{sec:layout-engines}
      \begin{metatext}
        ...
        It will also cover some optimizations that are done and which parts of the layout process that can be done in parallel in section~\ref{sec:parallel}.
        Lastly, layout thrashing will be presented and how it can be avoided in section~\ref{sec:layout-thrashing}.
      ...
      \subsection{Reference architecture and market shares}
        ...
        The parsing of \gls{HTML} is also done by the \gls{layout engine}.
