  ...
  \chapter{Background}\label{ch:background}
    ...
    \section{Layout engines}\label{sec:layout-engines}
      ...
      \subsection{Style computation}\label{sec:style-computation}
        ...
        The initial value is \code{auto}, the properties apply to all non-replaced inline \glspl{element}, table rows and row groups.
      ...
      \subsection{Layout thrashing and how to avoid it}\label{sec:layout-thrashing}
        ...
        When an element and its ancestors have been marked as dirty, a layout will need to be performed on the subtree which contains at least all $n$ \glspl{element} and possibly some ancestor \glspl{element}.
