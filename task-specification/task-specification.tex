...
\date{January 2015}
\blurb{Master's Thesis task specifikation\\\hfill\\ Supervisors at \textsc{evry ab}: Tomas Ekholm \& Stefan Senner\"{o}\\Supervisor at \textsc{csc}: Philipp Haller\\Examiner: Mads Dam}
\trita{}
\begin{document}
\frontmatter
\pagestyle{empty}
